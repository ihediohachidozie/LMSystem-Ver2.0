...
class PublicHolidayController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pubholiday.index', compact('publicholidays'));
    }
    ...
    public function create()
    {
        ...
        return view('pubholiday.create', compact('publicholiday'));
    }
    ...
    public function edit(PublicHoliday $publicholiday)
    {
        if(auth()->id() == 1)
        {
            return view('pubholiday.edit', compact('publicholiday'));
        }
        return back();
    }
